...
#define ACT_DIAG_READ_FRAGMENT		11	// Read fragment of the full array
#define ACT_DIAG_SAVE_TO_FILE		12	// Save raw data to file
//
...
#define REG_ENABLE_VOLTAGE_SMPL		5	// Enable voltage sampling
